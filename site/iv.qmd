...
g = pyvis.network.Network(notebook=True,directed=True, cdn_resources='in_line', height='300px', width='400px')
g.add_nodes(['X', 'Y', 'Z', 'ϵ'])
g.add_edge('X', 'Y')
g.add_edge('ϵ','Y')
g.add_edge('ϵ','X')
g.add_edge('Z','X')
g.show("generiv_iv.html")
```
:::
...
g = pyvis.network.Network(notebook=True,directed=True, cdn_resources='in_line', height='400px', width='500px')
g.add_nodes(['Education','Earnings','Ability','?'])
g.add_edge('Education', 'Earnings')
g.add_edge('Ability','Education')
g.add_edge('Ability','Earnings')
g.add_edge('?','Education')
g.show("ee0_iv.html")
```
...
```{python}
#| code-fold: true
g = pyvis.network.Network(notebook=True,directed=True, cdn_resources='in_line', height='400px', width='400px')
g.add_nodes(['Education','Earnings','Ability','Quarter of Birth'])
g.add_edge('Education', 'Earnings')
g.add_edge('Ability','Education')
g.add_edge('Ability','Earnings')
g.add_edge('Quarter of Birth','Education')
g.show("ee_iv.html")
```
:::
...
- Yes, two approaches lead to the same answers:
  1. Require uniform (over values of $\Er[Z_iX_i']$) convergence
