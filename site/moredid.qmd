...
## Regression with Cohort-Time Interactions
```{python}
pf.feols("y ~ -1 + C(cohort)*C(t) | id + t",df, vcov={"CRV1":"id"}).summary()
```
...
- Doubly robust estimator @sz2020
  - [doubleml](https://docs.doubleml.org/stable/examples/py_double_ml_did.html) package partially implements it
