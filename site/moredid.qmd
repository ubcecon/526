...
- Option 1: Use an appropriate package
   - [pyfixest](https://pypi.org/project/pyfixest/) see especially their [docs on difference in differences](https://py-econometrics.github.io/pyfixest/difference-in-differences.html)
   - [csdid](https://github.com/d2cml-ai/csdid)
   - doubleml (see chapter 16 of @causalml2024)
   - [differences](https://github.com/bernardodionisi/differences)
   - see [https://asjadnaqvi.github.io/DiD/](https://asjadnaqvi.github.io/DiD/) for more options
...
- Doubly robust estimator @sz2020
  ...
  - see example notebook from chapter 16 of @causalml2024


## Sources and Further Reading {.smaller}
