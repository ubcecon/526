...
rbf_feature = RBFSampler(gamma=0.2, random_state=1, n_components=100)
X_features = rbf_feature.fit_transform(X)
g = LassoCV(max_iter=10_000, n_jobs=-1, alphas=10**np.linspace(-2,5,50))
m = LogisticRegressionCV()
dmldata = dml.DoubleMLData.from_arrays(X_features, y, T)
